        ...
        <table class="min-w-full divide-y divide-gray-200 border border-green-400">
          ...
          @foreach ($posts as $post)
            ...
            <tr class="odd:bg-white even:bg-gray-100">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800  "><img src="image/{{$post->image}}" width=70px alt=""></td>
              ...
              <a href="{{route('edit',$post->id)}}" class="bg-green-600 px-3 py-2 text-white rounded"  >Edit</a>
              <a href="{{route('delete',$post->id)}}" class="bg-red-600 px-2 py-2 text-white rounded"  >Delete</a>
              </td>
